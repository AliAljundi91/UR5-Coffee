...
MOVING_ACCEL = 0.20*NORMAL_ACCEL_J

PICKUP_SPEED = 1*NORMAL_SPEED_L
PICKUP_ACCEL = 0.20*NORMAL_ACCEL_L
...
def pushBag(bagType, bagNr):
    ...
    moveJ(POSITIONS[bagType]["push3"][bagKey]["fullJ"])
    moveL(POSITIONS[bagType]["push3"][bagKey]["down"])
    moveL(POSITIONS[bagType]["push3"][bagKey]["orient"])
    moveL(POSITIONS[bagType]["push3"][bagKey]["push"], PICKUP_SPEED, PICKUP_ACCEL)
    moveL(POSITIONS[bagType]["push3"][bagKey]["down"])
    moveL(POSITIONS[bagType]["push3"][bagKey]["push"], PICKUP_SPEED, PICKUP_ACCEL)
    moveL(POSITIONS[bagType]["push3"][bagKey]["down"])
    moveL(POSITIONS[bagType]["push3"][bagKey]["full"])
    moveJ(POSITIONS[bagType]["push3"][bagKey]["halfJ"])
    moveL(POSITIONS[bagType]["push3"][bagKey]["quarter"])
    moveCrude()
